...
from functions import getTotalInvestorsCosts, getInterestingInvestors, getAdventuringInvestors
...
expected = testarg_investors_test1_2_4
result = getInterestingInvestors(testarg_investors_test1_2_4)
test('getInterestingInvestors - test 1',expected, result)

expected = testarg_investors_test1_2_4
result = getAdventuringInvestors(testarg_investors_test1_2_4)
test('getAdventuringInvestors - test 1',expected, result)
...
result = getInterestingInvestors(testarg_investors_test3)
test('getInterestingInvestors - test 3',expected, result)

expected = [{
    'profitReturn' : 5,
    'adventuring' : True
}]
result = getAdventuringInvestors(testarg_investors_test3)
test('getAdventuringInvestors - test 3',expected, result)
...
expected = testarg_investors_test5_7
result = getInterestingInvestors(testarg_investors_test5_7)
test('getInterestingInvestors - test 5',expected, result)
...
result = getAdventuringInvestors(testarg_investors_test5_7)
test('getAdventuringInvestors - test 5',expected, result)
...
expected = testarg_investors_test6
result = getInterestingInvestors(testarg_investors_test6)
test('getInterestingInvestors - test 6',expected, result)

expected = []
result = getAdventuringInvestors(testarg_investors_test6)
test('getAdventuringInvestors - test 6',expected, result)
